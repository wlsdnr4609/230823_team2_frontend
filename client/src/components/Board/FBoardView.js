 ...
 */
    handleDrop = (e) => {
     ...
     /* handlePostMenual() {
        ...
        return axios.post("http://localhost:8080/api/uploadAjax", formData).then(res => {
    ...
    /* handleFileUpload = async () => {
        try {
            ...
            // 파일 업로드 API 엔드포인트에 요청 보내기
            const response = await axios.post('http://localhost:8080/api/uploadAjax', formData, {
                headers: {
    ...
    handlePostMenual = async () => {
        try {
            const formData = new FormData();
            formData.append('file', this.state.selectedFile);

            const response = await axios.post('http://192.168.0.83:8080/api/uploadAjax', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
                                ...
                                <div class="tb_outline">
                                    <table class="table_ty1">
                                        ...
                                        <tr className="div_tb_tr fileb">
                                            <th>
                                                <label htmlFor="is_Swt_file">첨부파일<span className="red"></span></label>
                                            </th>
