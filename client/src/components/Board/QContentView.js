...
class QContentView extends Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            <article class="res_w">
                                <div class="tb_outline">
                                    ...
                                    <div class="btn_confirm mt20" style={{ "margin-bottom": "44px" }}>
                                        <Link to={'/QBoardList'} className="bt_ty bt_ty1 cancel_ty1">목록보기</Link>
                                        <Link to={'/QContentView2/' + this.state.before_swtcode} className="bt_ty bt_ty2 submit_ty1 modifyclass">수정</Link>
