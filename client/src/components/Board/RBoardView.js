...
class RBoardView extends Component {
    constructor(props) {
        super(props);
        this.state = {
            username: '',
                ...
                <article class="s_cnt mp_pro_li ct1">
                    ...
                    <div class="bo_w re1_wrap re1_wrap_writer">
                        <form name="frm" id="frm" action="" onsubmit="" method="post" >
                            <input id="is_Swtcode" type="hidden" name="btype" value="R" />
                                ...
                                <div class="tb_outline">
                                    <table class="table_ty1">
                                        <tr className="tr_tel">
                                             <th>게시판 종류</th>
                                                <td>
                                                <p  id="is_niname" name="btype" class=""  readonly="readonly">리뷰</p>
